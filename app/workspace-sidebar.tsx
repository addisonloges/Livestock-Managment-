...
{name:'Overview',icon:LayoutDashboard,items:[{id:'dashboard',name:'Dashboard'},{id:'calendar',name:'Calendar'},{id:'reports',name:'Reports'}]},
{name:'Animals',icon:Tags,items:[{id:'animals',name:'Animal register'},{id:'events',name:'Events & notes'},{id:'management',name:'Groups & watch list'},{id:'deleted',name:'Deleted animals'}]},
{name:'Breeding',icon:HeartHandshake,items:[{id:'breeding',name:'Groups & projects'},{id:'lambing',name:'Lambing'}]},
{name:'Growth',icon:Scale,items:[{id:'weights',name:'Weights & growth'},{id:'feed',name:'Feed & rations'}]},
{name:'Health',icon:HeartPulse,items:[{id:'health',name:'Treatments & inventory'}]},
{name:'Financials',icon:Wallet,items:[{id:'finance',name:'Income & expenses'}]},
{name:'Pedigree',icon:GitBranch,items:[{id:'pedigree',name:'Ancestry & COI'},{id:'genetics',name:'Genetic evaluations'}]}];
