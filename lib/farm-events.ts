import {validateSheepNutrition} from './sheep-ration.ts';
...
export function validateEvent(e:FarmEvent,animals:Animal[]){
 ...
 if(e.kind==='ration')validateSheepNutrition(e.ration!,e.species);
